<?php
class TipoProdutoTraitList extends TPage
{
    private $form;
    private $datagrid;
    ...
    public function __construct()
    {
        ...
        $this->setActiveRecord('Tipoproduto');
        $this->addFilterField('descricao', 'like', 'descricao');
        $this->setDefaultOrder('id', 'asc');
        
        $this->form = new BootstrapFormBuilder;
        $this->form->setFormTitle('Lista Tipo do Produto');
        
        $tipoproduto = new TEntry('descricao');
        
        $this->form->addFields( [new TLabel('Descrição')], [$tipoproduto] );
